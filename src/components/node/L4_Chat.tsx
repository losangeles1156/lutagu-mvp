...
import { useDifyChat, type DifyMessage, type QuickButton } from '@/hooks/useDifyChat';
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="font-black text-slate-800 tracking-tight">
                            {variant === 'bambi' ? tL4('bambiStrategy') : displayName}
                        </h3>
                        <div className="flex items-center gap-2">
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                                {variant === 'bambi' ? tL4('subtitle') : tL4('subtitle')}
                            </p>
                            {isOffline && (
                        ...
                        <div className={`max-w-[85%] rounded-2xl p-4 shadow-sm ${msg.role === 'user'
                            ...
                            <div className="flex items-center gap-2 mb-1 opacity-50">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-tighter">
                                    {msg.role === 'user' ? tL4('userLabel') : (variant === 'bambi' ? tL4('bambiLabel') : tL4('lutaguLabel'))}
                                </span>
                            </div>
