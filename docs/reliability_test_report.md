...
## 4. 可靠性與差異分析
### 4.1 顯著差異案例分析
| 案例 | BambiGO | Google Maps | 差異原因分析 |
| :--- | :--- | :--- | :--- |
| **大宮 → 新宿** | 15 分 | 35 分 | BambiGO 僅計算純行車時間，未包含大型車站（大宮、新宿）內的步行與候車時間。 |
| **淺草 → 都廳前** | 52 分 | 35 分 | **預期行為**：BambiGO 觸發了「藏前轉乘懲罰」，主動選擇了路程較長但轉乘更舒適的路線。 |
...
## 6. 結論
BambiGO 路線規劃演算法在**響應速度**與**連通可靠性**上表現卓越，完全能滿足實時交互需求。目前的「時間準確率」誤差主要來源於對大型車站站內時間的忽略以及刻意設計的舒適度懲罰。透過引入站內步行補償因子，預計準確率可提升至 90% 以上。
